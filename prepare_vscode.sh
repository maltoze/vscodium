...
setpath_json "product" "linkProtectionTrustedDomains" '["https://open-vsx.org", "https://*.deployai365.com", "https://*.google.com"]'
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "win32AppId" "{{63EE5873-EDC0-4B96-A33C-848918A8234C}"
  setpath "product" "win32x64AppId" "{{194AE48C-5471-4618-B812-0880DF96D9AF}"
  setpath "product" "win32arm64AppId" "{{65B6D8C1-67CA-4616-80B2-1FD3F43CDCE1}"
  setpath "product" "win32UserAppId" "{{1EA83E11-F270-4AFD-8223-0C1902D65EDC}"
  setpath "product" "win32x64UserAppId" "{{46C4D3AC-75BE-44B1-A674-5CB78F21E40A}"
  setpath "product" "win32arm64UserAppId" "{{4A1153B2-19C1-49AA-8C1A-007A7118C110}"
  ...
  setpath "product" "win32ContextMenu.x64.clsid" "77D2E54E-1F64-4BB7-903D-1DE617ACA40C"
  setpath "product" "win32ContextMenu.arm64.clsid" "2000A4B4-3169-4F5A-AEAE-6B1F983D1FB0"
fi
