...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "urlProtocol" "deployai-studio"
  ...
  setpath "product" "win32UserAppId" "{{65E00A5A-5BDA-4979-BB99-5D0C954C669F}"
  setpath "product" "win32x64UserAppId" "{{144AE3A8-C8C1-4AAC-AD9B-A321724B0102}"
  setpath "product" "win32arm64UserAppId" "{{42B5ADDF-7F66-4920-9E57-891C6F09BDCD}"
